...
Modern 3D renderer built on BLAZE implementing meshlets, GPU culling, and indirect rendering.
...
- **Comptime Scene Configuration** - Define scene capabilities at compile time
- **Data-Oriented Entity Storage** - Struct of Arrays for cache efficiency
- **Meshlet-Based Rendering** - Small mesh chunks for independent GPU culling
- **GPU Culling** - Frustum and occlusion culling in compute shaders
...
- WoW-style game rendering (many objects, stylized art)
...
Middle layer of the zig-graphics stack.
...
**Dependency**: BLAZE (GPU abstraction)
